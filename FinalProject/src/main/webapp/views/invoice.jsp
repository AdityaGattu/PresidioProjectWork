...
<body>
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16" class="btn btn-primary">
	 ...
	 Congrats!! Order Successfully Placed.</h1>
	

<h4 style="margin-left:150px; color:darkgreen;">Order Details : </h4>
<h5 style="float:left;margin-top:20px;margin-left:150px;font-size=20px; color:red;"> Name <h5>
<h5 style="float:left;margin-top:20px;margin-left:130px;font-size=20px;"> : ${bill.bname}<h5></br></br>
<div class="clear"/>
<h5 style="float:left;margin-top:10px;margin-left:150px;margin-bottom:30px;font-size=20px; color:red"> Billing Address </h5>
<h5 style="float:left;margin-top:10px;margin-left:50px;font-size=20px;"> : ${bill.address} </h5>
<div class="clear"/>
...
<table class="table" >
  ...
  <c:forEach items="${allitems}" var="item">
    <tr class="table-primary">
      ...
      <td style="font-weight:bold;margin-left:5px;"><c:out value="${item.qty}"/></td>
    ...
    <tr class="table-danger">
      <td colspan="4"  style="font-weight:bold;">Total Purchased Value : </td>
      <td style="font-weight:bold;margin-left:5px;">${cartvalue}</td>
			...
			<input type="submit" value="Generate Invoice"  class="btn btn-danger" style="float:right; margin-right:200px;"/>
